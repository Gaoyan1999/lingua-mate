...
def build_prompt(batch: list[dict[str, Any]], lesson: dict[str, Any], learner_level: str) -> str:
    ...
    return (
        ...
        "For readThrough, generate 0-3 connected-speech and spoken-listening notes per chunk: linking, reductions, "
        ...
        "For vocabulary, generate 0-3 concise word or phrase notes per chunk: idioms, phrasal verbs, collocations, "
        "advanced words, implied meaning, cultural references, or easily confused lexical phrases. Do not provide "
        "plain dictionary translation, and do not put connected-speech/linking explanations here unless the item is "
        "primarily a lexical phrase.\n"
