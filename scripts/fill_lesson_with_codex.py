...
def build_prompt(batch: list[dict[str, Any]], learner_level: str) -> str:
    ...
    return (
        ...
        "2. readThrough: 0-3 connected-speech listening notes, such as reductions, linking, weak forms, "
        "dropped sounds, stress, contractions, or fast-speech phrasing.\n"
        "3. vocabulary: 0-3 concise comprehension notes, such as idioms, phrasal verbs, collocations, "
        "implied meaning, register, discourse markers, or cultural references.\n"
